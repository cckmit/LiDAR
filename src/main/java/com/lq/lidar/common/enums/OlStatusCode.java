package com.lq.lidar.common.enums;
...
public enum OlStatusCode {
    ...
    /**
     * 交易明细交易类别(7023)：支付租金/转租赁租金 702300000036
     */
    TRANS_TYPE_SUBLEASE_PAY_RENT("702300000036"),
    /**
     * 交易明细交易类别(7023)：支付转租赁租金冲账 702300000037
     */
    ...
    /**
     * 结构化租赁类别(7033) : 无 703300000001
     */
    STRUCTURED_TYPE_NONE("703300000001"),
    /**
     * 结构化租赁类别(7033) : 法税结构 703200000002
     */
    ...
    /**
     * 摊销周期(7044):当前租赁期(704400000002)
     */
    ACCRUED_TERM_TYPE_CURRENT_LEASE_TERM("704400000002"),
    /**
     * 摊销周期(7044):剩余租赁期(704400000003)
     */
    ...
    /**
     * 通知类型(7055):指数租赁发票付款通知及租金明细(705500000001)
     */
    ...
    /**
     * 投放款其他款项财务处理方式(7057):合并至经营租赁固定资产成本02(飞机使用费/船舶其他/设备其他)(705700000007)
     */
    OTHER_PAY_ITEM_VOUCHER_TO_ASSET_COST02("705700000007"),
    /**
     * 投放款其他款项财务处理方式(7057):合并至其他业务成本-卖断-经营租赁(705700000008)
     */
    OTHER_PAY_ITEM_VOUCHER_TO_OTHER_COST("705700000008"),
    /**
     * 投放款其他款项财务处理方式(7057):合并至经营租赁固定资产成本03(商业物业土地摊销/飞机机供品)(705700000009)
     */
    OTHER_PAY_ITEM_VOUCHER_TO_ASSET_COST03("705700000009"),
    /**
     * 投放款其他款项财务处理方式(7057):合并至经营租赁固定资产成本04(商业物业物业管理费/飞机税费)(705700000010)
     */
    OTHER_PAY_ITEM_VOUCHER_TO_ASSET_COST04("705700000010"),
    /**
     * 投放款其他款项财务处理方式(7057):合并至经营租赁固定资产成本05(商业物业房产税/飞机管理费)(705700000011)
     */
    OTHER_PAY_ITEM_VOUCHER_TO_ASSET_COST05("705700000011"),
    /**
     * 投放款其他款项财务处理方式(7057):合并至经营租赁固定资产成本06(商业物业保险费)(705700000012)
     */
    OTHER_PAY_ITEM_VOUCHER_TO_ASSET_COST06("705700000012"),
    /**
     * 投放款其他款项财务处理方式(7057):合并至经营租赁固定资产成本07(商业物业土地使用税)(705700000013)
     */
    OTHER_PAY_ITEM_VOUCHER_TO_ASSET_COST07("705700000013"),
    /**
     * 投放款其他款项财务处理方式(7057):合并至经营租赁固定资产成本08(商业物业杂项)(705700000014)
     */
    OTHER_PAY_ITEM_VOUCHER_TO_ASSET_COST08("705700000014"),
    /**
     * 投放款其他款项财务处理方式(7057):合并至经营租赁固定资产成本09(商业物业副调基金)(705700000015)
     */
    OTHER_PAY_ITEM_VOUCHER_TO_ASSET_COST09("705700000015"),
    /**
     * 投放款其他款项财务处理方式(7057):合并至经营租赁固定资产成本12(飞机使用费(增值税17%)/船舶其他(增值税17%)/设备其他(增值税17%))(705700000016)
     */
    OTHER_PAY_ITEM_VOUCHER_TO_ASSET_COST12("705700000016"),
    /**
     * 投放款其他款项财务处理方式(7057):合并至经营租赁固定资产成本13(商业物业土地摊销(增值税5%)/飞机机供品(增值税17%))(705700000017)
     */
    OTHER_PAY_ITEM_VOUCHER_TO_ASSET_COST13("705700000017"),
    /**
     * 投放款其他款项财务处理方式(7057):合并至经营租赁固定资产成本14(商业物业物业管理费(增值税5%))(705700000018)
     */
    OTHER_PAY_ITEM_VOUCHER_TO_ASSET_COST14("705700000018"),
    /**
     * 投放款其他款项财务处理方式(7057):合并至经营租赁固定资产成本15(飞机管理费(增值税17%))(705700000019)
     */
    OTHER_PAY_ITEM_VOUCHER_TO_ASSET_COST15("705700000019"),
    /**
     * 投放款其他款项财务处理方式(7057):合并至经营租赁固定资产成本16(商业物业保险费(增值税5%))(705700000020)
     */
    OTHER_PAY_ITEM_VOUCHER_TO_ASSET_COST16("705700000020"),
    /**
     * 投放款其他款项财务处理方式(7057):合并至经营租赁固定资产成本18(商业物业杂项(增值税5%))(705700000021)
     */
    OTHER_PAY_ITEM_VOUCHER_TO_ASSET_COST18("705700000021"),
    /**
     * 投放款其他款项财务处理方式(7057):合并至经营租赁固定资产成本23(商业物业土地摊销(增值税11%))(705700000022)
     */
    OTHER_PAY_ITEM_VOUCHER_TO_ASSET_COST23("705700000022"),
    /**
     * 投放款其他款项财务处理方式(7057):合并至经营租赁固定资产成本24(商业物业物业管理费(增值税11%))(705700000023)
     */
    OTHER_PAY_ITEM_VOUCHER_TO_ASSET_COST24("705700000023"),
    /**
     * 投放款其他款项财务处理方式(7057):合并至经营租赁固定资产成本26(商业物业保险费(增值税11%))(705700000024)
     */
    OTHER_PAY_ITEM_VOUCHER_TO_ASSET_COST26("705700000024"),
    /**
     * 投放款其他款项财务处理方式(7057):合并至经营租赁固定资产成本28(商业物业杂项(增值税11%))(705700000025)
     */
    OTHER_PAY_ITEM_VOUCHER_TO_ASSET_COST28("705700000025"),
    /**
     * 投放款其他款项财务处理方式(7057):合并至费用支出-租赁项下手续费(705700000026)
     */
