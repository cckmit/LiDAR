...
//        objectMapper.registerModule(new GuavaModule());
    ...
    public static <V> V from(URL url, Class<V> type) {
        try {
            ...
            throw new RuntimeException("jackson from error");
        }
    }
    ...
    public static <V> V from(URL url, TypeReference<V> type) {
        try {
            ...
            throw new RuntimeException("jackson from error, url: {}, type: {}");
        }
    }
    ...
    public static <V> V from(InputStream inputStream, Class<V> type) {
        try {
            ...
            throw new RuntimeException("jackson from error, type: {}");
        }
    }
    ...
    public static <V> V from(File file, Class<V> type) {
        try {
            ...
            throw new RuntimeException("jackson from error, file path: {}, type: {}");
        }
    }
    ...
    public static <V> V from(String json, Type type) {
        ...
        try {
            ...
            throw new RuntimeException("jackson from error, json: {}, type: {}");
        }
    }
    ...
    public static <V> String to(List<V> list) {
        try {
            ...
            throw new RuntimeException("jackson to error, data: {}");
        }
    }
    ...
    public static <V> void toFile(String path, List<V> list) {
        try (Writer writer = new FileWriter(new File(path), true)) {
            ...
            throw new RuntimeException("jackson to file error, path: {}, list: {}");
        }
    }
    ...
    public static <V> void toFile(String path, V v) {
        try (Writer writer = new FileWriter(new File(path), true)) {
            ...
            throw new RuntimeException("jackson to file error, path: {}, data: {}");
        }
    }
    ...
    public static String getAsString(String json, String key) {
        ...
        try {
            ...
            throw new RuntimeException("jackson get string error, json: {}, key: {}");
        }
    }
    ...
    public static int getAsInt(String json, String key) {
        ...
        try {
            ...
            throw new RuntimeException("jackson get int error, json: {}, key: {}");
        }
    }
    ...
    public static long getAsLong(String json, String key) {
        ...
        try {
            ...
            throw new RuntimeException("jackson get long error, json: {}, key: {}");
        }
    }
    ...
    public static double getAsDouble(String json, String key) {
        ...
        try {
            ...
            throw new RuntimeException("jackson get double error, json: {}, key: {}");
        }
    }
    ...
    public static BigInteger getAsBigInteger(String json, String key) {
        ...
        try {
            ...
            throw new RuntimeException("jackson get big integer error, json: {}, key: {}");
        }
    }
    ...
    public static BigDecimal getAsBigDecimal(String json, String key) {
        ...
        try {
            ...
            throw new RuntimeException("jackson get big decimal error, json: {}, key: {}");
        }
    }
    ...
    public static boolean getAsBoolean(String json, String key) {
        ...
        try {
            ...
            throw new RuntimeException("jackson get boolean error, json: {}, key: {}");
        }
    }
    ...
    public static byte[] getAsBytes(String json, String key) {
        ...
        try {
            ...
            throw new RuntimeException("jackson get byte error, json: {}, key: {}");
        }
    }
    ...
    public static <V> V getAsObject(String json, String key, Class<V> type) {
        ...
        try {
            ...
            throw new RuntimeException("jackson get list error, json: {}, key: {}, type: {}");
        }
    }
    ...
    public static JsonNode getAsJsonObject(String json, String key) {
        try {
            ...
            throw new RuntimeException("jackson get object from json error, json: {}, key: {}");
        }
    }
    ...
    public static <V> String add(String json, String key, V value) {
        try {
            ...
            throw new RuntimeException("jackson add error, json: {}, key: {}, value: {}");
        }
    }
    ...
    public static String remove(String json, String key) {
        try {
            ...
            throw new RuntimeException("jackson remove error, json: {}, key: {}");
        }
    }
    ...
    public static <V> String update(String json, String key, V value) {
        try {
            ...
            throw new RuntimeException("jackson update error, json: {}, key: {}, value: {}");
        }
    }
    ...
    public static String format(String json) {
        try {
            ...
            throw new RuntimeException("jackson format json error, json: {}");
        }
    }
